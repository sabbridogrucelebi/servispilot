...
@section('title', 'Yeni Bakım Ekle')
@section('subtitle', 'Araç bakım ve tamir kaydı oluşturun')
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm font-medium text-slate-500">
                            Araç, tarih, kategori, işlem, kilometre, usta ve not bilgileriyle yeni bakım kaydı oluşturun.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach($vehicles as $vehicle)
                                <option
                                    value="{{ $vehicle->id }}"
                                    {{ (string) old('vehicle_id', $selectedVehicleId ?? null) === (string) $vehicle->id ? 'selected' : '' }}
                                >
            ...
            <div class="border-t border-slate-100 bg-slate-50/70 px-6 py-5">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div class="text-xs font-medium text-slate-500">
                        Tarih bugünün tarihiyle otomatik gelir, istenirse değiştirilebilir.
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateNextKm() {
        ...
        const type = typeSelect ? (typeSelect.value || '').toLocaleUpperCase('tr-TR').trim() : '';
        const km = kmInput ? parseInt(kmInput.value || 0, 10) : 0;
