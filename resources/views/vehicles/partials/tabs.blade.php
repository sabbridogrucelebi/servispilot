@php
    ...
    $tabs = [
        ['id' => 'general', 'label' => 'Analiz', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Face%20with%20Monocle.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'indigo', 'gradient' => 'from-indigo-600 to-blue-600'],
        ['id' => 'documents', 'label' => 'Belgeler', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Hand%20gestures/Writing%20Hand.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'amber', 'gradient' => 'from-amber-500 to-orange-600'],
        ['id' => 'fuels', 'label' => 'Yakıt', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Rocket.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'rose', 'gradient' => 'from-rose-500 to-red-600'],
        ['id' => 'maintenances', 'label' => 'Bakım', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/People/Man%20Mechanic.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'emerald', 'gradient' => 'from-emerald-500 to-teal-600'],
        ['id' => 'penalties', 'label' => 'Cezalar', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Hand%20gestures/Raised%20Hand.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'violet', 'gradient' => 'from-violet-500 to-purple-600'],
        ['id' => 'reports', 'label' => 'Raporlar', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Nerd%20Face.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'sky', 'gradient' => 'from-sky-500 to-cyan-600'],
        ['id' => 'images', 'label' => 'Galeri', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Star-Struck.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'fuchsia', 'gradient' => 'from-fuchsia-500 to-pink-600'],
    ];
@endphp
