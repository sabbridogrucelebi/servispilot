@php
    ...
    $tabs = [
        ['id' => 'general', 'label' => 'Analiz', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Bar%20Chart.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'indigo', 'gradient' => 'from-indigo-600 to-blue-600'],
        ['id' => 'documents', 'label' => 'Belgeler', 'icon' => '<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Open%20File%20Folder.png" class="w-8 h-8 drop-shadow-md" />', 'color' => 'amber', 'gradient' => 'from-amber-500 to-orange-600'],
