...
<head>
    ...
    <style>
        ...
        .system-name { font-size: 10px; font-weight: bold; color: #94a3b8; letter-spacing: 2px; }
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="company-info">
                ...
                <div class="system-name">SERVISPILOT PRO</div>
            </div>
        </div>
        ...
        <div class="info-grid">
            ...
            <div class="info-box" style="text-align: right;">
                ...
                <div class="value value-lg">{{ number_format($report['base_salary'], 2, ',', '.') }} ₺</div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                @foreach($report['details'] as $summary)
                    <tr>
                        <td>
                            <div class="font-black">{{ $summary['customer_name'] }}</div>
                            <div style="color: #2563eb; font-weight: bold;">{{ $summary['route_name'] }}</div>
                        </td>
                        <td class="text-center font-bold">{{ $summary['morning_count'] }}</td>
                        <td class="text-center font-bold">{{ $summary['evening_count'] }}</td>
        ...
        <div class="summary-grid">
            <div class="notes-area">
                ...
                <div style="font-size: 10px; margin-top: 5px;">
                    ...
                    @if($extraBonus == 0 && $deduction == 0) <div style="color: #94a3b8;">Herhangi bir ek kayıt bulunmamaktadır.</div> @endif
                </div>
            </div>
            <div class="total-box">
                ...
                <div class="summary-row" style="color: #fca5a5;">
                    <span>Kesintiler Toplamı:</span>
                    <span>-{{ number_format($bank + $penalty + $advance + $deduction, 2, ',', '.') }} ₺</span>
                </div>
                <div class="net-row">
        ...
        <div class="signatures">
            <div class="sig-box">
                ...
                <div class="sig-label">İşveren (İmza)</div>
                <div style="font-size: 9px; margin-top: 5px; color: #64748b;">IRMAK TURİZM TAŞIMACILIK</div>
            </div>
            <div class="sig-box">
                <div class="sig-line"></div>
                <div class="sig-label">Personel (İmza)</div>
                <div style="font-size: 11px; font-weight: 900; margin-top: 5px;">{{ $driver->full_name }}</div>
            </div>
        </div>

        <div style="margin-top: 40px; text-align: center; border-top: 1px dashed #e2e8f0; padding-top: 10px; font-size: 8px; color: #94a3b8;">
            Bu belge ServisPilot PRO altyapısı ile {{ now()->format('d.m.Y H:i') }} tarihinde oluşturulmuştur.
        </div>
    </div>
</body>
</html>
