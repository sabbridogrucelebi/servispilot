...
<head>
    ...
    <style>
        ...
        body { font-family: 'Inter', sans-serif; color: #1e293b; line-height: 1.4; margin: 0; padding: 0; background: white; font-size: 11px; -webkit-print-color-adjust: exact; }
        .page-break { page-break-after: always; }
        .container { width: 100%; max-width: 185mm; margin: 0 auto; padding-bottom: 20px; }
        
        .header { display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 4px solid #0f172a; padding-bottom: 15px; margin-bottom: 25px; }
        .header h1 { font-family: 'Outfit', sans-serif; margin: 0; font-size: 28px; font-weight: 900; color: #0f172a; letter-spacing: -1px; line-height: 1; }
        .header p { margin: 5px 0 0 0; color: #2563eb; font-weight: 800; font-size: 13px; letter-spacing: 1px; text-transform: uppercase; }
        .company-name { font-family: 'Outfit', sans-serif; font-size: 20px; font-weight: 900; color: #0f172a; letter-spacing: -0.5px; }
        .system-tag { display: inline-block; background: #0f172a; color: white; padding: 2px 8px; border-radius: 4px; font-size: 9px; font-weight: 900; margin-top: 4px; letter-spacing: 1px; }

        .info-grid { display: flex; gap: 15px; margin-bottom: 25px; }
        .info-card { flex: 1; background: #f8fafc; border: 1px solid #e2e8f0; padding: 15px; border-radius: 16px; }
        .label { font-size: 9px; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 6px; }
        .value { font-family: 'Outfit', sans-serif; font-size: 16px; font-weight: 800; color: #0f172a; }
        ...
        .total-card { flex: 1; background: #0f172a; color: white; padding: 25px; border-radius: 24px; }
        .summary-line { display: flex; justify-content: space-between; font-size: 11px; margin-bottom: 8px; color: #94a3b8; font-weight: 600; }
        .net-total { border-top: 1px solid rgba(255,255,255,0.1); margin-top: 15px; padding-top: 15px; display: flex; justify-content: space-between; align-items: center; }
        ...
        .sig-space { flex: 1; text-align: center; border-top: 2px solid #0f172a; padding-top: 10px; }
        ...
        <div class="container {{ $index < count($reports) - 1 ? 'page-break' : '' }}">
            ...
            <div class="info-grid">
                ...
                <div class="info-card" style="text-align: right;">
                    ...
                    <div class="value" style="font-size: 24px;">{{ number_format($report['base_salary'], 2, ',', '.') }} ₺</div>
                </div>
            </div>
            ...
            <div class="financials">
                ...
                <div class="total-card">
                    <div class="summary-line"><span>Toplam Hakediş</span><span style="color: white;">+{{ number_format($report['base_salary'] + $report['extra_earnings'] + $extraBonus, 2, ',', '.') }} ₺</span></div>
                    <div class="summary-line"><span>Toplam Kesintiler</span><span style="color: #fca5a5;">-{{ number_format($bank + $penalty + $advance + $deduction, 2, ',', '.') }} ₺</span></div>
                    <div class="net-total">
            ...
            <div class="signatures">
                <div class="sig-space"><div class="sig-title">İşveren Tasdik</div><div class="sig-name">IRMAK TURİZM</div></div>
                <div class="sig-space"><div class="sig-title">Personel Tebellüğ</div><div class="sig-name">{{ $driver->full_name }}</div></div>
            </div>
        </div>
    @endforeach
</body>
