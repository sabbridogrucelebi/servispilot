...
const AnimatedActionButton = ({ onPress, title }) => {
        ...
        <TouchableOpacity onPress={onPress} activeOpacity={0.8} style={{marginTop: 4}}>
            <View style={[s.actionBtn, { overflow: 'hidden', shadowColor: '#0A192F', marginTop: 0 }]}>
                ...
                >
                    ...
                    <Text style={[s.actionBtnText, {color: '#fff', textTransform: 'capitalize'}]}>{title}</Text>
                ...
                <View style={[s.statusBox, isOverdue && { borderColor: '#FECACA', backgroundColor: '#FEF2F2' }]}>
                    <View style={s.statusTop}>
                        <View style={s.dateWrap}>
                            <Icon name={isOverdue ? "alert-circle" : "shield-half-full"} size={16} color={isOverdue ? "#EF4444" : "#D946EF"} style={{marginTop: 2}} />
                            <View style={{marginLeft: 6}}>
                                <Text style={[s.dateLabel, isOverdue && { color: '#EF4444' }]}>POLİÇE BİTİŞ</Text>
                    ...
                    <AnimatedActionButton title="Sigorta Bilgilerine Git" onPress={() => navigation.navigate('VehicleDetail', { vehicle: item })} />
                </View>
            </TouchableOpacity>
        );
    };
            ...
            <SafeAreaView edges={['top']} style={{ flex: 1 }}>
                ...
                <View style={[s.appBar, { marginTop: 20 }]}>
                    ...
                    <View style={{alignItems: 'center', flex: 1, marginRight: 44}}>
                        <Text style={s.appBarTitle}>Yaklaşan Sigortalar</Text>
                    </View>
                </View>
                    ...
                    <FlatList
                        ...
                        ListEmptyComponent={
                            <View style={s.emptyState}>
                                ...
                                <Text style={s.emptyDesc}>Yakın zamanda sigorta poliçesi bitecek veya gecikmiş aracınız bulunmuyor.</Text>
                            </View>
                        }
                    />
                )}
...
const s = StyleSheet.create({
    ...
    dateLabel: { fontSize: 10, fontWeight: '800', color: '#D946EF', letterSpacing: 0.5 },
    dateValue: { fontSize: 14, fontWeight: '900', color: '#D946EF', marginTop: 2 },
